...
case $select in
        ...
        1-3)./run_pia_demo_pyqt.sh --number_of_channels 1 --settings_mode 1 --camera_mode 1;;
        2)./run_pia_demo_pyqt.sh --number_of_channels 16;;
        2-2)./run_pia_demo_pyqt.sh --number_of_channels 16 --settings_mode 1;;
        2-3)./run_pia_demo_pyqt.sh --number_of_channels 16 --settings_mode 1 --camera_mode 1;;
