...
def main():
    ...
    text_encoder = PiaONNXTensorRTModel(model_path=args.text_encoder_onnx, device=device)
    token_embedder = PiaONNXTensorRTModel(model_path=args.token_embedder_onnx, device=device)
