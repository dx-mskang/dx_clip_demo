...
from common.base import CombinedMeta, Base
from viewmodel.clip_view_model import ClipViewModel, SentenceViewModel
from common.config.ui_config import UIHelper, UIConfig
from view.multithreading.clip_video_consumer import ClipVideoConsumer
from view.multithreading.video_producer import VideoProducer
from view.multithreading.video_worker import VideoWorker
...
class ClipView(Base, QMainWindow, metaclass=CombinedMeta):
    def __init__(self, view_model: ClipViewModel, ui_config: UIConfig, base_path, adjusted_video_path_lists):
        ...
        self.clear_button.clicked.connect(self.__view_model.clear_sentence)

        # Connect sentence input enter key event
        self.sentence_input.returnPressed.connect(self.__view_model.push_sentence)  # enter key
